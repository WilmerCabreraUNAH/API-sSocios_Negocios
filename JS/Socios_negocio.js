var UrlGetSocios_negocios= 'http://localhost:90/G5_20/Socios_negocios/controller/socios_negocio.php?opcion=GetSocios_negocios';
var UrlPostSocios_negocios= 'http://localhost:90/G5_20/Socios_negocios/controller/socios_negocio.php?opcion=Insertar_Socio_negocios';
var UrlGetUno= 'http://localhost:90/G5_20/Socios_negocios/controller/socios_negocio.php?opcion=GetUno';
var UrlPostActualizar= 'http://localhost:90/G5_20/Socios_negocios/controller/socios_negocio.php?opcion=Actualizar_Socio_negocios';
var UrlDelet= 'http://localhost:90/G5_20/Socios_negocios/controller/socios_negocio.php?opcion=Eliminar_Socio_negocios';
